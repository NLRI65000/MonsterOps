...
PRESETS: dict[str, dict] = {
    "radius": {
        ...
        "rules": [
            {"chain": "input", "action": "accept", "protocol": "udp", "dport": "1812,1813",
    ...
    "radius_coa": {
        ...
        "rules": [
            {"chain": "input", "action": "accept", "protocol": "udp", "dport": "3799",
    ...
    "radsec": {
        ...
        "rules": [
            {"chain": "input", "action": "accept", "protocol": "tcp", "dport": "2083",
    ...
    "ssh": {
        ...
        "rules": [
            {"chain": "input", "action": "accept", "protocol": "tcp", "dport": "22", "comment": "SSH"},
        ],
    },
    "web": {
        ...
        "rules": [
            {"chain": "input", "action": "accept", "protocol": "tcp", "dport": "80,443",
             "comment": "HTTP/HTTPS"},
        ],
    },
}
